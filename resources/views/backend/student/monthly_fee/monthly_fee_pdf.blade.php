...
<table id="customers">
    <tr>
      <td>
        ...
        <img src="{{ public_path() . $image_path }}" width="120" height="100">
      </td>

      <td><h3>School ERP</h3>
      <p>School Address</p>
      <p>Phone: 5012334</p>
      <p>Email: info@schoolerp.com</p>
...
@php
    ...
    // Registration Fee Functionality
...
<table id="customers">
  ...
  <tr>
  <td>9</td>
    <td><b>Fee For The Month of {{ $month }}</b></td>
    <td> ${{ $finalfee }}</td>
  </tr> 
...
<hr style="border: dashed 2px; width: 100%; color: #000; margin-bottom: 50px;">
<table id="customers">
<tr>
    <th width="10%">SL No.</th>
    <th width="45%">Student Details</th>
