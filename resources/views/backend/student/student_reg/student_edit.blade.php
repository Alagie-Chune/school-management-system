                                ...
                                <div class="form-group">
                                  ...
                                  <div class="controls">
                                    <select name="gender" id="gender" required class="form-control">
                                      ...
                                      <option value="Female" value="Male" {{ ($editData['student']['gender'] == 'Female') ? 'selected' : '' }}>Female</option>
                                  </select>
                                  </div>
                                </div>
                              </div> <!-- End col-md-4 -->
                            ...
                            <div class="row"> <!-- 3rd row -->
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  <div class="controls">
                                    <input type="discount" name="discount" class="form-control" required value="{{ $editData['discount']['discount'] }}">
                                  </div>
                                </div>
                              </div> <!-- End col-md-4 -->
