                      ...
                      <tbody>
                          ...
                          <tr>
                              <td>{{ $key+1 }}</td>
                                ...
                                <td>
                                  <img src="{{ (!empty($value['student']['image'])) ? url('upload/student_images/'.$value['student']['image']) : url('upload/no_image.jpg') }}" style="width:60px; height:60px;"> {{-- "['student']" as the Method name and "['student']" as the Image field name --}}
                                </td>
                                <td>{{ $value->year_id }}</td>
                              <td>
